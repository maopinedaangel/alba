            ...
            <form>
                ...
                <section id="sec-current-ailing">
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <label>
                                ¿Estás tomando algún medicamento por prescripción médica o se está auto medicando?
                                ¿Cuál?:
                            </label>
                ...
                <section id="sec-background" v-on:change="printDiseases">
                    ...
                    <table>
                        <tr>
                            ...
                            <th v-for="(disease, k) in diseases" :key="k">
                                {{ disease }}
                            </th>
                        </tr>
                        <tr v-for="(relative, j) in Object.keys(form.familyBackground)" :Key="j">
                            ...
                            <td v-for="(disease, k) in diseases" :key="k">
                                <input
                                    type="checkbox"
                                    :value="disease"
                                    v-model="form.familyBackground[relative].results" />
                            </td>
                        </tr>
                    </table>
                </section>
                ...
                <section>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-social-status"
                                type="text"
                                v-model="form.nonPathologicalBackground.socialStatus"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-housing"
                                type="text"
                                v-model="form.nonPathologicalBackground.housing"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-hygiene"
                                type="text"
                                v-model="form.nonPathologicalBackground.hygiene"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-feeding"
                                type="text"
                                v-model="form.nonPathologicalBackground.feeding"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-immunization"
                                type="text"
                                v-model="form.nonPathologicalBackground.immunization"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-eruptive-fever"
                                type="text"
                                v-model="form.pathologicalBackground.eruptiveFever"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-infectious-parasitic"
                                type="text"
                                v-model="form.pathologicalBackground.infectious"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-jaundiced"
                                type="text"
                                v-model="form.pathologicalBackground.jaundiced"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-hormonal"
                                type="text"
                                v-model="form.pathologicalBackground.hormonal"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-epileptic"
                                type="text"
                                v-model="form.pathologicalBackground.epileptic"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-allergic"
                                type="text"
                                v-model="form.pathologicalBackground.allergic"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-surgical"
                                type="text"
                                v-model="form.pathologicalBackground.surgical"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-traumatic"
                                type="text"
                                v-model="form.pathologicalBackground.traumatic"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-transfusion"
                                type="text"
                                v-model="form.pathologicalBackground.transfusion"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <label for="inp-substance-use">
                                Consumo de sustancias (tabaco, alcohol y otras drogas):
                            </label>
                            <input
                                name="inp-substance-use"
                                type="text"
                                v-model="form.pathologicalBackground.substanceUse"
                                required />
                        </div>
                    </div>
                </section>
                ...
                <section id="sec-systems">
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                Cardiovascular, respiratorio, digestivo, endocrino, genitourinario, neurológico, piel,
                ...
                <section id="sec-physical-exam">
                    ...
                    <div class="form-line">
                        ...
                        <div class="form-field">
                            ...
                            <input
                                name="inp-actual-weight"
                                type="text"
                                v-model="form.vitalSigns.actualWeight"
                                required />
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input
                                name="inp-blood-pressure"
                                type="text"
                                v-model="form.vitalSigns.bloodPressure"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        ...
                        <div class="form-field">
                            ...
                            <input
                                name="inp-breathing-rate"
                                type="text"
                                v-model="form.vitalSigns.breathingRate"
                                required />
                        </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-head-and-neck"
                                type="text"
                                v-model="form.neurologicExamination.headAndNeck"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-abdomen"
                                type="text"
                                v-model="form.neurologicExamination.abdomen"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-genitals"
                                type="text"
                                v-model="form.neurologicExamination.genitals"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-limbs-and-skin"
                                type="text"
                                v-model="form.neurologicExamination.limbsAndSkin"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-cranial-nerves"
                                type="text"
                                v-model="form.neurologicExamination.cranialNerves"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-motor-system"
                                type="text"
                                v-model="form.neurologicExamination.motorSystem"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-sensitivity"
                                type="text"
                                v-model="form.neurologicExamination.sensitivity"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-reflexes"
                                type="text"
                                v-model="form.neurologicExamination.reflexes"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-balance"
                                type="text"
                                v-model="form.neurologicExamination.balance"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-brain-dominance"
                                type="text"
                                v-model="form.neurologicExamination.brainDominance"
                                required />
                        </div>
                    </div>
                </section>
                ...
                <section id="sec-mental">
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                Inspección general (apariencia, actitud, conciencia, conducta motor, forma de relación,
                                autismo)
                            </label>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                Lenguaje y pensamiento: Fluidez, retardo, aceleración, articulación, coherencia,
                                tonalidad, congruencia, riqueza de asociaciones y abstracciones, fobias, obsesiones y
                                delirios
                            </label>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                Funciones intelectuales, orientación, atención, comprensión, concentración, memoria,
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                Afectividad, indiferencia, tristeza, euforia, labilidad, ansiedad, aplanamiento,
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                Senso percepción, ilusiones, alucinaciones, alucinosis, despersonalización, micropsias,
                ...
                <section id="sec-diagnostic">
                    ...
                    <div class="form-line">
                        <div class="form-field">
                            ...
                            <input
                                name="inp-diagnostic-code"
                                type="text"
                                v-model="form.diagnostic.findings[0].code"
                                required />
                        </div>
                        <div class="form-field-triple">
                            ...
                            <input
                                name="inp-diagnostic"
                                type="text"
                                v-model="form.diagnostic.findings[0].diagnostic"
                                required />
                        </div>
                    </div>
                ...
                <section id="sec-suggested-treatment">
                    ...
                    <div class="form-line">
                        <div class="form-field">
                            <label>
                                <input type="checkbox" v-model="form.suggestedTreatment.type" />
                                Terapia individual
                            </label>
                        </div>
                        <div class="form-field">
                    ...
                    <div class="form-line">
                        ...
                        <div class="form-field">
                            <label>
                                <input type="checkbox" v-model="form.suggestedTreatment.frequency" />
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                Plan de manejo físico (si se necesitan medicamentos, deberá señalar dosis, vía y
                                periodicidad)
                            </label>
                    ...
                    <div class="form-line">
                        ...
                        <div class="form-field">
                            ...
                            <input
                                name="inp-responsible"
                                type="text"
                                v-model="form.nextAppointment.responsible"
                                required />
                        </div>
                    </div>
                    <div class="form-line">
                        ...
                        <div class="form-field-double">
                            <label for="inp-doctor">
                                Nombre completo y firma del profesional que otorgó el servicio:
                            </label>
...
export default {
    ...
    data: function () {
        return {
            ...
            diseases: [
                "Enfermedades Crónico-degenrativas",
                "Infecto-Contagiosas",
                "Alérgicas",
                "Eventos Traumáticos",
                "Consumo de Sustancias y/o con Problemas",
