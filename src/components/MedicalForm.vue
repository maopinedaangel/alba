            ...
            <section id="sec-general">
                ...
                <div class="form-line">
                    ...
                    <div class="form-field">
                        ...
                        <input name="inp-hour" type="hour" v-model="form.hour" required>
                    </div> 
                    <div class="form-field">
                ...
                <table>
                    ...
                    <tr v-for="(relative, j) in Object.keys(form.familyBackground)" :Key="j">
                        ...
                        <td v-for="(disease, k) in diseases" :key="k">
                            <input type="checkbox" :value="disease" v-model="form.familyBackground[relative]">
                        </td>
                    </tr>
                </table>
            </section>
            ...
            <section id="sec-mental">
                ...
                <div class="form-line">
                    <div class="form-field-full-line">                
                        ...
                        <textarea v-model="form.mentalExamination.preception" required></textarea><br>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        printDiseases: function() {
            console.log(this.form.familyBackground);
        }
    },
    created: function() {
        setTimeout(() => {
