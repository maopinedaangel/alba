            ...
            <form disabled>
                ...
                <section class="form-section" id="sec-user-data">
                    ...
                    <div class="form-line">
                        ...
                        <div class="form-field">
                            ...
                            <input
                                name="inp-civil-status"
                                type="text"
                                v-model="entryForm.patient.civilState"
                                disabled />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field">
                            ...
                            <input
                                name="inp-school-grade"
                                type="text"
                                v-model="entryForm.patient.schoolGrade"
                                disabled />
                        </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-triple">
                            <!--Ingresos previos-->
                            <label for="inp-previous-entries">
                                ¿Cuántos ingresos previos ha tenido al establecimiento?
                            </label>
                            <input
                                name="inp-previous-entries"
                                type="text"
                                v-model="entryForm.previousEntries"
                                disabled />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        ...
                        <div class="form-field">
                            ...
                            <input
                                name="inp-referred-by"
                                type="text"
                                v-model="entryForm.referredBy"
                                :disabled="entryForm.isReferred === 'No'" />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <textarea v-model="entryForm.motive" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <textarea v-model="entryForm.healthCondition" required></textarea>
                        </div>
                    </div>
                </section>
                ...
                <section class="form-section" id="sec-representative-data">
                    ...
                    <div class="form-line">
                        <div class="form-field">
                            ...
                            <input
                                name="inp-representative-name"
                                type="text"
                                v-model="entryForm.representative.name"
                                disabled />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field">
                            ...
                            <input
                                ...
                                type="number"
                                v-model="entryForm.representative.age"
                                disabled />
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input
                                name="inp-relationship"
                                type="text"
                                v-model="entryForm.representative.relationship"
                                disabled />
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input
                                name="inp-occupation"
                                type="text"
                                v-model="entryForm.representative.occupation"
                                disabled />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-representative-address"
                                type="text"
                                v-model="entryForm.representative.address"
                                disabled />
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <input
                                name="inp-representative-phone"
                                type="text"
                                v-model="entryForm.representative.phone"
                                disabled />
                        </div>
                    </div>
                </section>
                ...
                <section class="form-section" id="sec-acceptance-criteria">
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                <input type="checkbox" v-model="entryForm.isAMan" v-on:change="checkCriteria" />
                                El usuario/a es hombre
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                <input type="checkbox" v-model="entryForm.isAdult" v-on:change="checkCriteria" />
                                El usuario/a es mayor de edad
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                <input
                                    type="checkbox"
                                    v-model="entryForm.substanceDependance"
                                    v-on:change="checkCriteria" />
                                El usuario/a presenta un nivel de dependencia al alcohol o drogas
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                <input
                                    type="checkbox"
                                    v-model="entryForm.presentsConsequences"
                                    v-on:change="checkCriteria" />
                                El usuario/a presenta alguna(s) consecuencia(s) asociadas al consumo
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                <input
                                    type="checkbox"
                                    v-model="entryForm.noMentalDisorder"
                                    v-on:change="checkCriteria" />
                                El usuario/a no presenta algún trastorno mental o psiquiátrico que le impida
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                <input type="checkbox" v-model="entryForm.meetsCriteria" disabled />
                                El usuario/a cumple con todos los criterios de admisión al tratamiento
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label for="inp-remission-place">
                                En caso de no haber cumplido los criterios, indicar el lugar al que será referido/a:
                            </label>
...
export default {
    ...
    watch: {
        meetsCriteria: function () {
            this.entryForm.meetsCriteria =
                this.entryForm.isAMan &&
                this.entryForm.isAdult &&
                this.entryForm.substanceDependance &&
                this.entryForm.presentsConsequences &&
                this.entryForm.noMentalDisorder;
        },
    },
