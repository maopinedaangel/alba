            ...
            <form v-on:change="calculateTotalScore">
                        ...
                        <div class="div-inline-options">
                            <label for="op-possession-1">
                                <input
                                    ...
                                    id="op-possession-1"
                                    value="3"
                                    v-model.number="form.possessionType" />
                                Propia (3)
                            </label>
                            ...
                            <tr v-for="(type, k) in housingTypes" :key="k">
                                <td>
                                    <label for="inp-housing-type">
                                        <input
                                            type="radio"
                                            id="op-housing-type-1"
                                            :value="type.points"
                                            v-model.number="form.housingType" />
                                        {{ type.name }}
                                    </label>
                                </td>
                                <td>{{ type.type }}</td>
                    ...
                    <div class="form-line">
                        ...
                        <div class="div-inline-checks" v-on:change="updatePublicServicesPoints">
                            <label for="check-public-services-1">
                                <input
                                    type="checkbox"
                                    id="check-public-services-1"
                                    value="Alumbrado público"
                                    v-model="form.publicServices" />
                                Alumbrado público
                            </label>
                            <label for="check-public-services-2">
                                <input
                                    type="checkbox"
                                    id="check-public-services-2"
                                    value="Pavimentación"
                                    v-model="form.publicServices" />
                                Pavimentación
                            </label>
                    ...
                    <div class="form-line">
                        ...
                        <div class="div-inline-checks" v-on:change="updateInternalServicesPoints">
                            <label for="check-internal-services-1">
                                <input
                                    type="checkbox"
                                    id="check-internal-services-1"
                                    value="Alumbrado público"
                                    v-model="form.internalServices" />
                                Alumbrado público
                            </label>
                            <label for="check-internal-services-2">
                                <input
                                    type="checkbox"
                                    id="check-internal-services-2"
                                    value="Pavimentación"
                                    v-model="form.internalServices" />
                                Pavimentación
                            </label>
                        ...
                        <div class="div-inline-options">
                            <label for="op-material-1">
                                <input
                                    ...
                                    id="op-material-1"
                                    value="2"
                                    v-model.number="form.constructionMaterial" />
                                Mampostería (2)
                            </label>
                    ...
                    <div class="form-line">
                        ...
                        <div class="div-inline-options">
                            <label for="op-persons-by-bedroom-1">
                                <input
                                    type="radio"
                                    id="op-persons-by-bedroom-1"
                                    value="2"
                                    v-model.number="form.personsByBedroom" />
                                1 - 2 (2)
                            </label>
                            <label for="op-persons-by-bedroom-2">
                                <input
                                    type="radio"
                                    id="op-persons-by-bedroom-2"
                                    value="1"
                                    v-model.number="form.personsByBedroom" />
                                3 (1)
                            </label>
                ...
                <section class="form-section" id="sec-health-condition">
                        ...
                        <div class="div-inline-options">
                            <label for="op-duration-1">
                                <input
                                    ...
                                    id="op-duration-1"
                                    value="2"
                                    v-model.number="form.illnessDuration" />
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            <label>
                                ¿El/la paciente tiene otros problemas de salud, además del que presenta y por el cual se
                                atiende en otra institución?:
                            </label>
                        </div>
                        <!--</div>
                    <div class="form-line">-->
                        <div class="div-inline-options">
                            <label for="other-diseases-no">
                                <input
                                    type="radio"
                                    id="other-diseases-no"
                                    value="1"
                                    v-model.number="form.otherDiseases" />
                                No (1)
                            </label>
                            <label for="other-disease-yes">
                                <input
                                    type="radio"
                                    id="other-diseases-yes"
                                    value="0"
                                    v-model.number="form.otherDiseases" />
                                Sí (0)
                            </label>
                    ...
                    <div class="form-line">
                        ...
                        <div class="div-inline-options">
                            <label for="op-family-condition-1">
                                <input
                                    type="radio"
                                    id="op-family-condition-1"
                                    value="2"
                                    v-model.number="form.familyCondition" />
                                Ningún enfermo (2)
                            </label>
                            <label for="op-family-condition-1">
                                <input
                                    type="radio"
                                    id="op-family-condition-2"
                                    value="1"
                                    v-model.number="form.familyCondition" />
                                Un enfermo (1)
                            </label>
                ...
                <section class="form-section" id="sec-family-dynamics">
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <textarea v-model="form.feelingsAboutFamily" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <textarea v-model="form.familyFeelings" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <textarea v-model="form.familyNeedsToImprove" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <textarea v-model="form.patientNeedsToImprove" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <textarea v-model="form.hasDisagreementsWith" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <textarea v-model="form.hasAgreementsWith" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-line">
                        <div class="form-field-full-line">
                            ...
                            <textarea v-model="form.socialDiagnostic" required></textarea>
                        </div>
                    </div>
                </section>
    ...
    methods: {
        ...
        calculateIncome: function () {
            this.form.totalIncome =
                this.form.familyBossIncome + this.form.spouseIncome + this.form.childrenIncome + this.form.othersIncome;
        },
        calculateExpenses: function () {
            this.form.totalExpenses =
                this.form.foodExpenses +
                this.form.rentExpenses +
                this.form.propertyExpenses +
                this.form.waterSupplyExpenses +
                this.form.electricityExpenses +
                this.form.gasExpenses +
                this.form.phoneExpenses +
                this.form.schoolExpenses +
                this.form.healthExpenses +
                this.form.transportationExpenses +
                this.form.domesticWorkExpenses +
                this.form.otherExpenses;
        },
        calculateTotalScore: function () {
            this.form.totalScore =
                this.form.possessionType +
                this.form.housingType +
                this.form.publicServicesPoints +
                this.form.internalServicesPoints +
                this.form.constructionMaterial +
                this.form.bedrooms +
                this.form.personsByBedroom +
                this.form.illnessDuration +
                this.form.otherDiseases +
